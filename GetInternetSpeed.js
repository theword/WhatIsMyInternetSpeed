...
const languageStrings = {
    'en': {
        translation: {
            FACTS: [
                'Your Internet speed is very slow. 4 Megabytes per second download. 0.03 Metabytes per second upload. Web browsing should work, but videos could load slowly.' 
                
            ],
            SKILL_NAME: 'Whatismyinternetspeed',
            GET_FACT_MESSAGE: "Your Internet speed is very slow. 4 Megabytes per second download. 0.03 Metabytes per second upload. Web browsing should work, but videos could load slowly."     ,
